...
% Author: Evan Putnam
% This is a resume template that I use for all job applications.
% Font options are available below for windows/mac fonts
% Note that there is a single error that occurs on compilation.
% This error is nesicary to get the document in the right proportions.
